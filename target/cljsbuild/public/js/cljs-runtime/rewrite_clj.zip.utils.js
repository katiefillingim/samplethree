...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__63213,k,f){
var vec__63215 = p__63213;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63215,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63215,(1),null);
var loc = vec__63215;
...
var G__63250 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__63250;
continue;
}
break;
...
var G__63251 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__63251;
continue;
} else {
return zloc__$1;
...
var G__63252 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__63252;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__63225){
var vec__63226 = p__63225;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63226,(0),null);
var map__63229 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63226,(1),null);
...
var path = map__63229__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63229__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__63226;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__63232){
var vec__63233 = p__63232;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63233,(0),null);
var map__63236 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63233,(1),null);
...
var path = map__63236__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63236__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__63233;
if(cljs.core.seq(r)){
...
var map__63243 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63240,(1),null);
...
var path = map__63243__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63243__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63243__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63243__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63243__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
