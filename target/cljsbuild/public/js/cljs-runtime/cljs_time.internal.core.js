...
var len__4736__auto___74435 = arguments.length;
var i__4737__auto___74436 = (0);
while(true){
if((i__4737__auto___74436 < len__4736__auto___74435)){
args__4742__auto__.push((arguments[i__4737__auto___74436]));

var G__74437 = (i__4737__auto___74436 + (1));
i__4737__auto___74436 = G__74437;
continue;
} else {
}
break;
...
if(cljs.core.every_QMARK_((function (p1__74389_SHARP_){
return (p1__74389_SHARP_ instanceof goog.date.Date);
}),args)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__74390_SHARP_){
return p1__74390_SHARP_.getTime();
}),args));
} else {
...
/** @this {Function} */
(cljs_time.internal.core._EQ_.cljs$lang$applyTo = (function (seq74391){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq74391));
}));
...
var G__74396 = (cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([month,(1)], 0)))?(11):(month - (1)));
return (cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1 ? cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1(G__74396) : cljs_time.internal.core.days_in_month.call(null,G__74396));
});
cljs_time.internal.core.year_corrected_dim = (function cljs_time$internal$core$year_corrected_dim(year,month){
var G__74398 = cljs_time.internal.core.corrected_dim(month);
...
cljs_time.internal.core.valid_date_QMARK_ = (function cljs_time$internal$core$valid_date_QMARK_(p__74401){
var map__74402 = p__74401;
var map__74402__$1 = (((((!((map__74402 == null))))?(((((map__74402.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__74402.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__74402):map__74402);
var d = map__74402__$1;
var minutes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"minutes","minutes",1319166394));
var millis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"millis","millis",-1338288387));
var day_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"day-of-week","day-of-week",1639326729));
var months = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"months","months",-45571637));
var days = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"days","days",-1394072564));
var weekyear = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"weekyear","weekyear",-74064500));
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var weekyear_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"weekyear-week","weekyear-week",795291571));
var hours = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"hours","hours",58380855));
var years = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74402__$1,new cljs.core.Keyword(null,"years","years",-1298579689));
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Date is not valid",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"invalid-date","invalid-date",2030506573),new cljs.core.Keyword(null,"date","date",-1463434462),d,new cljs.core.Keyword(null,"errors","errors",-908790718),(function (){var G__74411 = cljs.core.PersistentArrayMap.EMPTY;
var G__74411__$1 = ((months_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411,new cljs.core.Keyword(null,"months","months",-45571637),months):G__74411);
var G__74411__$2 = ((days_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$1,new cljs.core.Keyword(null,"days","days",-1394072564),days):G__74411__$1);
var G__74411__$3 = ((hours_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$2,new cljs.core.Keyword(null,"hours","hours",58380855),hours):G__74411__$2);
var G__74411__$4 = ((minutes_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$3,new cljs.core.Keyword(null,"minutes","minutes",1319166394),minutes):G__74411__$3);
var G__74411__$5 = ((seconds_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$4,new cljs.core.Keyword(null,"seconds","seconds",-445266194),seconds):G__74411__$4);
var G__74411__$6 = ((millis_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$5,new cljs.core.Keyword(null,"millis","millis",-1338288387),millis):G__74411__$5);
var G__74411__$7 = ((weekyear_week_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$6,new cljs.core.Keyword(null,"weekyear-week","weekyear-week",795291571),weekyear_week):G__74411__$6);
if(day_of_week_QMARK_ === false){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__74411__$7,new cljs.core.Keyword(null,"day-of-week","day-of-week",1639326729),day_of_week);
} else {
return G__74411__$7;
}
})()], null));
...
return cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__74413_SHARP_,p2__74412_SHARP_){
if(cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p2__74412_SHARP_,x], 0)))){
return p1__74413_SHARP_;
} else {
return null;
}
}),coll));
...
var args__4742__auto__ = [];
var len__4736__auto___74471 = arguments.length;
var i__4737__auto___74472 = (0);
while(true){
if((i__4737__auto___74472 < len__4736__auto___74471)){
args__4742__auto__.push((arguments[i__4737__auto___74472]));

var G__74473 = (i__4737__auto___74472 + (1));
i__4737__auto___74472 = G__74473;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_time.internal.core.format.cljs$lang$applyTo = (function (seq74414){
var G__74415 = cljs.core.first(seq74414);
var seq74414__$1 = cljs.core.next(seq74414);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74415,seq74414__$1);
}));
