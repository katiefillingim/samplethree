...
return (function() { 
var G__60376__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__60376 = function (var_args){
var args = null;
...
while (G__60377__i < G__60377__a.length) {G__60377__a[G__60377__i] = arguments[G__60377__i + 0]; ++G__60377__i;}
  args = new cljs.core.IndexedSeq(G__60377__a,0,null);
} 
return G__60376__delegate.call(this,args);};
G__60376.cljs$lang$maxFixedArity = 0;
G__60376.cljs$lang$applyTo = (function (arglist__60380){
var args = cljs.core.seq(arglist__60380);
return G__60376__delegate(args);
});
G__60376.cljs$core$IFn$_invoke$arity$variadic = G__60376__delegate;
return G__60376;
})()
;
} else {
...
var G__60275 = o;
goog.object.set(G__60275,day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(v));
...
var G__60287 = props;
var G__60287__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60287,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__60287);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60287__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__60287__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.set_id_class((function (){var G__60289 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60289,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__60289;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v10v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__60294){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60295__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__60310_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_handle_change(this$,on_change,p1__60310_SHARP_);
}));
} else {
return null;
}
...
var vec__60323 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60323,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60323,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60323,(2),null);
...
var temp__5739__auto___60427 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___60427 == null)){
} else {
var key_60428 = temp__5739__auto___60427;
(jsprops.key = key_60428);
}
...
var temp__5739__auto___60433 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___60433 == null)){
} else {
var key_60434 = temp__5739__auto___60433;
(jsprops.key = key_60434);
}
...
var G__60349 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__60349) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.call(null,G__60349));
} else {
var temp__5739__auto___60435 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___60435 == null)){
} else {
var key_60437 = temp__5739__auto___60435;
(jsprops.key = key_60437);
}
...
var G__60356 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__60356)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60356)){
return x;
} else {
...
var len__4736__auto___60438 = arguments.length;
var i__4737__auto___60439 = (0);
while(true){
if((i__4737__auto___60439 < len__4736__auto___60438)){
args__4742__auto__.push((arguments[i__4737__auto___60439]));

var G__60440 = (i__4737__auto___60439 + (1));
i__4737__auto___60439 = G__60440;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq60357){
var G__60358 = cljs.core.first(seq60357);
var seq60357__$1 = cljs.core.next(seq60357);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60358,seq60357__$1);
}));
...
break;
default:
var G__60446 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__60446;
continue;
...
var ctx = ({});
var vec__60361 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60361,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60361,(1),null);
...
var G__60364 = (cljs.core.count(argv) - first_child);
switch (G__60364) {
case (0):
