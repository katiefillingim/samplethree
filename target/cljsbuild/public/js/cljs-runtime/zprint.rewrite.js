...
var G__63545 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__63545;
continue;
} else {
var G__63546 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__63546;
continue;
}
} else {
var G__63547 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__63547;
continue;
}
}
...
var G__63537 = zloc;
var G__63538 = (function (){var G__63539 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__63540 = zloc;
var G__63540__$1 = (((G__63540 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__63540) : rewrite_clj.zip.node.call(null,G__63540)));
if((G__63540__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__63540__$1) : zprint.zutil.edn_STAR_.call(null,G__63540__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__63539) : rewrite_clj.zip.root.call(null,G__63539));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__63537,G__63538) : rewrite_clj.zip.replace.call(null,G__63537,G__63538));
});
/**
...
var G__63552 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__63552;
continue;
}
break;
...
var G__63555 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__63556 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__63555;
out = G__63556;
continue;
} else {
...
var G__63559 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__63560 = cljs.core.next(new_loc);
var G__63561 = replaced_loc;
nloc = G__63559;
new_loc = G__63560;
last_loc = G__63561;
continue;
...
return zprint.rewrite.sort_val((function (){var G__63541 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__63541) : rewrite_clj.zip.down.call(null,G__63541));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__63542_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__63542_SHARP_) : rewrite_clj.zip.tag.call(null,p1__63542_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__63542_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__63542_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
