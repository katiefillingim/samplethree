...
var periods__$1 = cljs.core.vec((function (){var G__74824 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__74823_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__74823_SHARP_,(0),(3));
}),G__74824);
} else {
return G__74824;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__74834){
var vec__74835 = p__74834;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74835,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74835,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__74838 = pattern;
switch (G__74838) {
case "S":
...
switch (G__74848__$1) {
case "millis":
return (function (p1__74840_SHARP_){
return p1__74840_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__74841_SHARP_){
return p1__74841_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__74842_SHARP_){
return p1__74842_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__74843_SHARP_){
return p1__74843_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__74844_SHARP_){
return p1__74844_SHARP_.getHours();
});

break;
case "day":
return (function (p1__74845_SHARP_){
return p1__74845_SHARP_.getDate();
});

break;
case "month":
return (function (p1__74846_SHARP_){
return p1__74846_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__74847_SHARP_){
return p1__74847_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74848__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__74849){
var vec__74850 = p__74849;
var seq__74851 = cljs.core.seq(vec__74850);
var first__74852 = cljs.core.first(seq__74851);
var seq__74851__$1 = cljs.core.next(seq__74851);
var key = first__74852;
var args = seq__74851__$1;
var G__74853 = key;
...
break;
case "ordinal-suffix":
var vec__74854 = (function (){var G__74857 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__74857) : syntax_list.call(null,G__74857));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74854,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__74853__$1)].join('')));
...
var d = value;
var G__74861 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__74862 = G__74861;
...
var unparser = first__74864;
var more = seq__74863__$1;
var s = "";
var d__$1 = d;
var G__74861__$1 = G__74861;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__74871 = G__74861__$1;
var seq__74872 = cljs.core.seq(vec__74871);
var first__74873 = cljs.core.first(seq__74872);
var seq__74872__$1 = cljs.core.next(seq__74872);
var unparser__$1 = first__74873;
var more__$1 = seq__74872__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__74874 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74874,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74874,(1),null);
var G__74903 = d__$3;
var G__74904 = more__$1;
var G__74905 = s__$3;
d__$1 = G__74903;
G__74861__$1 = G__74904;
s__$1 = G__74905;
continue;
}
break;
