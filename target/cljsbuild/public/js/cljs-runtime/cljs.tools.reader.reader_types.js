...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_58067 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_58067(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_58068 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_58068(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58073 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_58073(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58074 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_58074(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58075 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_58075(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58080 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_58080(reader);
}
});
...
var G__58109 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__58110 = s.append(c);
c = G__58109;
s = G__58110;
continue;
}
