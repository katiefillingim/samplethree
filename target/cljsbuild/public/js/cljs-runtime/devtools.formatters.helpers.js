...
var G__56084 = devtools.prefs.pref(v);
v = G__56084;
continue;
} else {
return v;
...
}catch (e55943){var _e__54682__auto__ = e55943;
return false;
}})();
...
}catch (e55971){var _e__54682__auto__ = e55971;
return false;
}})();
...
}catch (e55973){var _e__54682__auto__ = e55973;
return false;
}}
}
});
...
var vec__56029 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56029,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56029,(1),null);
...
return cljs.core.some((function (p1__56047_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__56047_SHARP_);
}),template);
});
