...
var G__63314 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__63314__$1 = (((G__63314 == null))?null:cljs.core.iterate((function (loc){
...
var G__63314__$2 = (((G__63314__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__63314__$1));
var G__63314__$3 = (((G__63314__$2 == null))?null:cljs.core.last(G__63314__$2));
if((G__63314__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__63314__$3);
}
} else {
return zloc;
}
...
var G__63337 = rewrite_clj.zip.move.right(v);
var G__63338 = rewrite_clj.zip.move.up(v);
loc = G__63337;
parent = G__63338;
continue;
} else {
var G__63339 = rewrite_clj.zip.move.right(v0);
var G__63340 = parent;
loc = G__63339;
parent = G__63340;
continue;
...
var G__63341 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__63342 = rewrite_clj.zip.move.up(v);
loc = G__63341;
parent = G__63342;
continue;
} else {
var G__63343 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__63344 = parent;
loc = G__63343;
parent = G__63344;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__63335 = zloc;
var G__63335__$1 = (((G__63335 == null))?null:rewrite_clj.zip.move.down(G__63335));
var G__63335__$2 = (((G__63335__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__63335__$1,k));
if((G__63335__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__63335__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__63336 = rewrite_clj.zip.move.down(zloc);
var G__63336__$1 = (((G__63336 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__63336));
if((G__63336__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__63336__$1);
}
})(),k);
}
});
