...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__61469){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61470__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61470__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61470__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61470__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61470__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61482){
var vec__61484 = p__61482;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61484,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61484,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61479_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__61479_SHARP_,/:/);
...
var len__4736__auto___61520 = arguments.length;
var i__4737__auto___61521 = (0);
while(true){
if((i__4737__auto___61521 < len__4736__auto___61520)){
args__4742__auto__.push((arguments[i__4737__auto___61521]));

var G__61522 = (i__4737__auto___61521 + (1));
i__4737__auto___61521 = G__61522;
continue;
} else {
}
break;
...
var previous_config__61450__auto__ = devtools.prefs.get_prefs();
var prefs__61451__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__61451__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__61451__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__61451__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__61450__auto__);
}}));

(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq61490){
var G__61491 = cljs.core.first(seq61490);
var seq61490__$1 = cljs.core.next(seq61490);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61491,seq61490__$1);
}));
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq61492){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61492));
}));
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq61493){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61493));
}));
...
var args__4742__auto__ = [];
var len__4736__auto___61537 = arguments.length;
var i__4737__auto___61538 = (0);
while(true){
if((i__4737__auto___61538 < len__4736__auto___61537)){
args__4742__auto__.push((arguments[i__4737__auto___61538]));

var G__61539 = (i__4737__auto___61538 + (1));
i__4737__auto___61538 = G__61539;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq61494){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61494));
}));
...
var expanded_QMARK_ = (function (){var G__61495 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61495) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__61495));
})();
...
var G__61496 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61496) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__61496));
...
})())?(function (){var G__61497 = day8.re_frame_10x.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__61498 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__61497,G__61498) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__61497,G__61498));
})():(function (){var G__61499 = day8.re_frame_10x.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__61500 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"header","header",119441134));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__61499,G__61500) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__61499,G__61500));
})())], null);
});
});
/**
...
var vec__61502 = jsonml;
var seq__61503 = cljs.core.seq(vec__61502);
var first__61504 = cljs.core.first(seq__61503);
var seq__61503__$1 = cljs.core.next(seq__61503);
var tag_name = first__61504;
var first__61504__$1 = cljs.core.first(seq__61503__$1);
var seq__61503__$2 = cljs.core.next(seq__61503__$1);
var attributes = first__61504__$1;
var children = seq__61503__$2;
...
var G__61505 = child;
var G__61506 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__61505,G__61506) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__61505,G__61506));
})),children);
} else {
...
var expanded_QMARK_ = (function (){var G__61507 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61507) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.subscribe.call(null,G__61507));
})();
...
var G__61508 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61508) : day8.re_frame_10x.inlined_deps.re_frame.v0v12v0.re_frame.core.dispatch.call(null,G__61508));
...
var args__4742__auto__ = [];
var len__4736__auto___61549 = arguments.length;
var i__4737__auto___61551 = (0);
while(true){
if((i__4737__auto___61551 < len__4736__auto___61549)){
args__4742__auto__.push((arguments[i__4737__auto___61551]));

var G__61552 = (i__4737__auto___61551 + (1));
i__4737__auto___61551 = G__61552;
continue;
} else {
}
break;
...
(day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__61513){
var vec__61514 = p__61513;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61514,(0),null);
var expanded_QMARK_ = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (data__$1){
...
/** @this {Function} */
(day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq61510){
var G__61511 = cljs.core.first(seq61510);
var seq61510__$1 = cljs.core.next(seq61510);
var G__61512 = cljs.core.first(seq61510__$1);
var seq61510__$2 = cljs.core.next(seq61510__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61511,G__61512,seq61510__$2);
}));
