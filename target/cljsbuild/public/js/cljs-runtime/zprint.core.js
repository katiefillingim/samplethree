...
var vec__65241 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__65244 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65244,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65244,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65241,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65241,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__65247){
var vec__65248 = p__65247;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65248,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65248,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65251,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65251,(1),null);
...
var vec__65263 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65263,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65263,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65263,(2),null);
var vec__65266 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65266,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65266,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65266,(2),null);
...
var G__65269 = special_option;
var G__65269__$1 = (((G__65269 instanceof cljs.core.Keyword))?G__65269.fqn:null);
switch (G__65269__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__65270){
var vec__65271 = p__65270;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65271,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65271,(1),null);
...
var len__4736__auto___65348 = arguments.length;
var i__4737__auto___65349 = (0);
while(true){
if((i__4737__auto___65349 < len__4736__auto___65348)){
args__4742__auto__.push((arguments[i__4737__auto___65349]));

var G__65350 = (i__4737__auto___65349 + (1));
i__4737__auto___65349 = G__65350;
continue;
} else {
}
break;
...
var vec__65283 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65283,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65283,(1),null);
...
var G__65288 = zprint.core.parse_string_all_options(rest_options);
var G__65289 = zprint.core.zprint_str_internal;
var G__65290 = ":parse-string-all? call";
var G__65291 = (function (){var G__65292 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__65292) : zprint.zutil.edn_STAR_.call(null,G__65292));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__65288,G__65289,G__65290,G__65291) : zprint.core.process_multiple_forms.call(null,G__65288,G__65289,G__65290,G__65291));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__65296 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65296,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65296,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq65277){
var G__65278 = cljs.core.first(seq65277);
var seq65277__$1 = cljs.core.next(seq65277);
var G__65279 = cljs.core.first(seq65277__$1);
var seq65277__$2 = cljs.core.next(seq65277__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65278,G__65279,seq65277__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65368 = arguments.length;
var i__4737__auto___65369 = (0);
while(true){
if((i__4737__auto___65369 < len__4736__auto___65368)){
args__4742__auto__.push((arguments[i__4737__auto___65369]));

var G__65370 = (i__4737__auto___65369 + (1));
i__4737__auto___65369 = G__65370;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq65301){
var G__65302 = cljs.core.first(seq65301);
var seq65301__$1 = cljs.core.next(seq65301);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65302,seq65301__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65371 = arguments.length;
var i__4737__auto___65372 = (0);
while(true){
if((i__4737__auto___65372 < len__4736__auto___65371)){
args__4742__auto__.push((arguments[i__4737__auto___65372]));

var G__65373 = (i__4737__auto___65372 + (1));
i__4737__auto___65372 = G__65373;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq65303){
var G__65304 = cljs.core.first(seq65303);
var seq65303__$1 = cljs.core.next(seq65303);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65304,seq65303__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65380 = arguments.length;
var i__4737__auto___65381 = (0);
while(true){
if((i__4737__auto___65381 < len__4736__auto___65380)){
args__4742__auto__.push((arguments[i__4737__auto___65381]));

var G__65383 = (i__4737__auto___65381 + (1));
i__4737__auto___65381 = G__65383;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq65305){
var G__65306 = cljs.core.first(seq65305);
var seq65305__$1 = cljs.core.next(seq65305);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65306,seq65305__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___65388 = arguments.length;
var i__4737__auto___65389 = (0);
while(true){
if((i__4737__auto___65389 < len__4736__auto___65388)){
args__4742__auto__.push((arguments[i__4737__auto___65389]));

var G__65390 = (i__4737__auto___65389 + (1));
i__4737__auto___65389 = G__65390;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq65307){
var G__65308 = cljs.core.first(seq65307);
var seq65307__$1 = cljs.core.next(seq65307);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65308,seq65307__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__65315,form){
var vec__65316 = p__65315;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65316,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65316,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65316,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65316,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__65319 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65319,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65319,(1),null);
...
var forms = (function (){var G__65325 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__65325) : zprint.zutil.edn_STAR_.call(null,G__65325));
})();
