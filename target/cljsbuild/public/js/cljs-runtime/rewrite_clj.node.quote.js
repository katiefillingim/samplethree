...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k61800,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__61810 = k61800;
var G__61810__$1 = (((G__61810 instanceof cljs.core.Keyword))?G__61810.fqn:null);
switch (G__61810__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61800,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__61811){
var vec__61812 = p__61811;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61812,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61812,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61799){
var self__ = this;
var G__61799__$1 = this;
return (new cljs.core.RecordIter((0),G__61799__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61801,other61802){
var self__ = this;
var this61801__$1 = this;
return (((!((other61802 == null)))) && ((this61801__$1.constructor === other61802.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61801__$1.tag,other61802.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61801__$1.prefix,other61802.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61801__$1.sym,other61802.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61801__$1.children,other61802.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61801__$1.__extmap,other61802.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__61799){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__61833 = cljs.core.keyword_identical_QMARK_;
var expr__61834 = k__4388__auto__;
if(cljs.core.truth_((pred__61833.cljs$core$IFn$_invoke$arity$2 ? pred__61833.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__61834) : pred__61833.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__61834)))){
return (new rewrite_clj.node.quote.QuoteNode(G__61799,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__61833.cljs$core$IFn$_invoke$arity$2 ? pred__61833.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__61834) : pred__61833.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__61834)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__61799,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__61833.cljs$core$IFn$_invoke$arity$2 ? pred__61833.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__61834) : pred__61833.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__61834)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__61799,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__61833.cljs$core$IFn$_invoke$arity$2 ? pred__61833.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__61834) : pred__61833.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__61834)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__61799,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__61799),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__61799){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__61799,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__61803){
var extmap__4419__auto__ = (function (){var G__61839 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61803,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__61803)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61839);
} else {
return G__61839;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__61803),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__61803),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__61803),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__61803),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__61916 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__61916;
continue;
}
break;
...
var G__61918 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__61918;
continue;
}
break;
...
var G__61919 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__61919;
continue;
}
break;
...
var G__61922 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__61922;
continue;
}
break;
