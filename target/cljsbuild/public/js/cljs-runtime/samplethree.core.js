...
var with_let56466 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let56466","with-let56466",-1672900206));
var temp__5739__auto___56471 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___56471 == null)){
} else {
var c__54083__auto___56472 = temp__5739__auto___56471;
if((with_let56466.generation === c__54083__auto___56472.ratomGeneration)){
...
(with_let56466.generation = c__54083__auto___56472.ratomGeneration);
}


var init56467 = (with_let56466.length === (0));
var expanded_QMARK_ = ((init56467)?(with_let56466[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let56466[(0)]));
...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-key","set-key",-48186176),new cljs.core.Keyword(null,"result","result",1415092211),x], null));
...
samplethree.core.math = (function samplethree$core$math(){
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["in math :x",cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"x","x",2099068185)], null)))," :y ",cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"y","y",-1757859776)], null)))], 0));

return ajax.core.POST.cljs$core$IFn$_invoke$arity$variadic(["/api/math/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(samplethree.core.ops,cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"op","op",-1882987955)], null)))))].join(''),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.PersistentArrayMap(null, 1, ["Accept","application/transit+json"], null),new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"x","x",2099068185),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"x","x",2099068185)], null))),new cljs.core.Keyword(null,"y","y",-1757859776),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"y","y",-1757859776)], null)))], null),new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__56468_SHARP_){
return samplethree.core.handler(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(p1__56468_SHARP_));
})], null)], 0));
});
samplethree.core.do_math = (function samplethree$core$do_math(num){
var G__56470 = samplethree.core.math();
var fexpr__56469 = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"x","x",2099068185)], null))))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"result","result",1415092211)], null)))))))?(function (){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-key","set-key",-48186176),new cljs.core.Keyword(null,"x","x",2099068185),num], null));

return (samplethree.core.equals = " = ");
})()
:((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"y","y",-1757859776)], null))))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-value","get-value",2108514284),new cljs.core.Keyword(null,"result","result",1415092211)], null)))))))?re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-key","set-key",-48186176),new cljs.core.Keyword(null,"y","y",-1757859776),num], null)):(function (){
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-key","set-key",-48186176),new cljs.core.Keyword(null,"y","y",-1757859776),num], null));
})()
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-key","set-key",-48186176),new cljs.core.Keyword(null,"op","op",-1882987955),"/"], null));
})], null),"/"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",934104792)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.calc-size.numbers","span.calc-size.numbers",629724788),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),cljs.core.deref(re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-color","get-color",-2122105193)], null)))], null)], null)], null)], null)], null);
});
