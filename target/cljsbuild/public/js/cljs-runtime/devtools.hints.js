...
}catch (e54908){var _e = e54908;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___54999 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___54999)){
var seen_errors_55011 = temp__5733__auto___54999;
if(cljs.core.truth_(seen_errors_55011.has(self))){
} else {
seen_errors_55011.add(self);

var temp__5735__auto___55012 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___55012)){
var sense_55013 = temp__5735__auto___55012;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_55013)].join(''));
} else {
}
}
} else {
