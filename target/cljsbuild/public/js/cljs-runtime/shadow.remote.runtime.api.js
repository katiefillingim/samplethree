...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_69448 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_69448(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_69451 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_69451(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_69455 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_69455(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_69461 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_69461(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_69465 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_69465(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_69471 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_69471(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__69444,callback){
var map__69445 = p__69444;
var map__69445__$1 = (((((!((map__69445 == null))))?(((((map__69445.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69445.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69445):map__69445);
var input = map__69445__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69445__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69445__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
