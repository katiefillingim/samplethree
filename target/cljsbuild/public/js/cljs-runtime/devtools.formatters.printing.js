...
var len__4736__auto___57003 = arguments.length;
var i__4737__auto___57004 = (0);
while(true){
if((i__4737__auto___57004 < len__4736__auto___57003)){
args__4742__auto__.push((arguments[i__4737__auto___57004]));

var G__57007 = (i__4737__auto___57004 + (1));
i__4737__auto___57004 = G__57007;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq56746){
var G__56747 = cljs.core.first(seq56746);
var seq56746__$1 = cljs.core.next(seq56746);
var G__56748 = cljs.core.first(seq56746__$1);
var seq56746__$2 = cljs.core.next(seq56746__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56747,G__56748,seq56746__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__56812_SHARP_){
return (!((cljs.core.meta(p1__56812_SHARP_) == null)));
})))){
...
var map__56835 = opts;
var map__56835__$1 = (((((!((map__56835 == null))))?(((((map__56835.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56835.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56835):map__56835);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56835__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e56880){var _e__54682__auto__ = e56880;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e56917){var _e__54682__auto__ = e56917;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__56969 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__56971 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__56971);

try{var map__56974 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56974__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__56969);
}});
...
var temp__5733__auto___57228 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___57228)){
var managed_print_level_57229 = temp__5733__auto___57228;
var _STAR_print_level_STAR__orig_val__56990_57232 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__56991_57233 = managed_print_level_57229;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__56991_57233);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__56983_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__56983_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__56990_57232);
}} else {
job_fn();
}
