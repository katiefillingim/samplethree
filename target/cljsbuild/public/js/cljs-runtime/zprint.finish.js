...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__61581_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__61581_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__61581_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__61585){
var vec__61586 = p__61585;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61586,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61586,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__61593,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61594__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61594__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61594__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__61599 = (function (){var or__4126__auto__ = color;
...
var fexpr__61598 = (function (){var G__61600 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__61600) : style_map.call(null,G__61600));
})();
return (fexpr__61598.cljs$core$IFn$_invoke$arity$1 ? fexpr__61598.cljs$core$IFn$_invoke$arity$1(G__61599) : fexpr__61598.call(null,G__61599));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__61601){
var vec__61602 = p__61601;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61602,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61602,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61602,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__61606){
var vec__61607 = p__61606;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61607,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61607,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61607,(2),null);
...
var G__61661 = cljs.core.next(ssv);
var G__61662 = (this_ssv == null);
var G__61663 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__61664 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__61661;
doing_nil_QMARK_ = G__61662;
last_elide = G__61663;
out = G__61664;
continue;
}
...
var vec__61614 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61614,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61614,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61614,(2),null);
...
var G__61665 = cljs.core.next(remaining_cvec);
var G__61666 = new_idx;
var G__61667 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__61665;
idx = G__61666;
out = G__61667;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__61621,cursor_vec){
var vec__61622 = p__61621;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(1),null);
var focus_vec = vec__61622;
...
var vec__61625 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61625,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61625,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__61628){
var vec__61629 = p__61628;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61629,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61629,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__61635,existing_count){
var vec__61636 = p__61635;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61636,(1),null);
...
return cljs.core.filterv((function (p1__61632_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__61632_SHARP_))));
...
var vec__61642 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61642,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61642,(1),null);
var cvec_element = vec__61642;
if((cvec_element == null)){
var G__61681 = cljs.core.next(cvec_nl);
var G__61682 = (idx + (1));
var G__61683 = start;
var G__61684 = out;
cvec_nl = G__61681;
...
var G__61685 = cljs.core.next(cvec_nl);
var G__61686 = (idx + (1));
var G__61687 = idx;
var G__61688 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__61685;
idx = G__61686;
start = G__61687;
out = G__61688;
...
var G__61689 = cljs.core.next(cvec_nl);
var G__61690 = (idx + (1));
var G__61691 = (idx + (1));
var G__61692 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__61689;
idx = G__61690;
start = G__61691;
out = G__61692;
...
var G__61693 = cljs.core.next(cvec_nl);
var G__61694 = (idx + (1));
var G__61695 = idx;
var G__61696 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__61693;
idx = G__61694;
start = G__61695;
out = G__61696;
...
var G__61698 = cljs.core.next(cvec_nl);
var G__61699 = (idx + (1));
var G__61700 = start;
var G__61701 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__61698;
idx = G__61699;
start = G__61700;
out = G__61701;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__61646_SHARP_,p2__61645_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__61645_SHARP_)){
return cljs.core.reduced(p1__61646_SHARP_);
} else {
return (p1__61646_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__61647,p__61648){
var vec__61649 = p__61647;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61649,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61649,(1),null);
var vec__61652 = p__61648;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61652,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61652,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__61656,cvec,focus_vec){
...
var map__61658 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61657__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61658__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61658__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61658__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61655_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__61655_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
