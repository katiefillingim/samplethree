...
if((c === "\n")){
var G__62715 = escape_QMARK_;
var G__62716 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__62715;
lines = G__62716;
continue;
} else {
buf.append(c);

var G__62718 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__62719 = lines;
escape_QMARK_ = G__62718;
lines = G__62719;
continue;
...
var G__62704 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__62704) : rewrite_clj.node.string_node.call(null,G__62704));
});
...
var G__62711 = cljs.core.re_pattern(regex);
var G__62712 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__62711,G__62712) : rewrite_clj.node.token_node.call(null,G__62711,G__62712));
});
