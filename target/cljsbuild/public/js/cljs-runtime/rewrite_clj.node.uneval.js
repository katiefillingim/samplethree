...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k61855,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61855,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__61875){
var vec__61876 = p__61875;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61876,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61876,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61854){
var self__ = this;
var G__61854__$1 = this;
return (new cljs.core.RecordIter((0),G__61854__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61856,other61857){
var self__ = this;
var this61856__$1 = this;
return (((!((other61857 == null)))) && ((this61856__$1.constructor === other61857.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61856__$1.children,other61857.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61856__$1.__extmap,other61857.__extmap)));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__61854){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__61895 = cljs.core.keyword_identical_QMARK_;
var expr__61896 = k__4388__auto__;
if(cljs.core.truth_((pred__61895.cljs$core$IFn$_invoke$arity$2 ? pred__61895.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__61896) : pred__61895.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__61896)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__61854,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__61854),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__61854){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__61854,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__61859){
var extmap__4419__auto__ = (function (){var G__61914 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__61859,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__61859)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61914);
} else {
return G__61914;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__61859),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__61963 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__61963;
continue;
}
break;
