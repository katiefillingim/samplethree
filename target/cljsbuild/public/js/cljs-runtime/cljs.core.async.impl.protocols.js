...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_67621 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_67621(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_67623 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_67623(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_67625 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_67625(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_67627 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_67627(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_67628 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_67628(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_67630 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_67630(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_67633 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_67633(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_67636 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_67636(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_67639 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_67639(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_67640 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_67640(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_67645 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_67645(b);
}
});
