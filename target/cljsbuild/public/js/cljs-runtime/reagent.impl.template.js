...
var G__64460 = o;
goog.object.set(G__64460,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__64600__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__64600 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__64601__i = 0, G__64601__a = new Array(arguments.length -  0);
while (G__64601__i < G__64601__a.length) {G__64601__a[G__64601__i] = arguments[G__64601__i + 0]; ++G__64601__i;}
  args = new cljs.core.IndexedSeq(G__64601__a,0,null);
} 
return G__64600__delegate.call(this,args);};
G__64600.cljs$lang$maxFixedArity = 0;
G__64600.cljs$lang$applyTo = (function (arglist__64604){
var args = cljs.core.seq(arglist__64604);
return G__64600__delegate(args);
});
G__64600.cljs$core$IFn$_invoke$arity$variadic = G__64600__delegate;
return G__64600;
})()
;
} else {
...
var G__64483 = o;
goog.object.set(G__64483,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__64609__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__64609 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__64610__i = 0, G__64610__a = new Array(arguments.length -  0);
while (G__64610__i < G__64610__a.length) {G__64610__a[G__64610__i] = arguments[G__64610__i + 0]; ++G__64610__i;}
  args = new cljs.core.IndexedSeq(G__64610__a,0,null);
} 
return G__64609__delegate.call(this,args);};
G__64609.cljs$lang$maxFixedArity = 0;
G__64609.cljs$lang$applyTo = (function (arglist__64611){
var args = cljs.core.seq(arglist__64611);
return G__64609__delegate(args);
});
...
var G__64493 = props;
var G__64493__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64493,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__64493);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64493__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__64493__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__64500 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64500,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__64500;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__64505){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64506__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__64525_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__64525_SHARP_);
}));
} else {
return null;
}
...
var vec__64529 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64529,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64529,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64529,(2),null);
...
var temp__5739__auto___64637 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___64637 == null)){
} else {
var key_64638 = temp__5739__auto___64637;
(jsprops.key = key_64638);
}
...
var temp__5739__auto___64642 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___64642 == null)){
} else {
var key_64643 = temp__5739__auto___64642;
(jsprops.key = key_64643);
}
...
var G__64557 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__64557) : reagent.impl.template.as_element.call(null,G__64557));
} else {
var temp__5739__auto___64654 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___64654 == null)){
} else {
var key_64656 = temp__5739__auto___64654;
(jsprops.key = key_64656);
}
...
var G__64564 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__64564)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__64564)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq64568){
var G__64569 = cljs.core.first(seq64568);
var seq64568__$1 = cljs.core.next(seq64568);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64569,seq64568__$1);
}));
...
break;
default:
var G__64671 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__64671;
continue;
...
var ctx = ({});
var vec__64584 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64584,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64584,(1),null);
...
var G__64587 = (cljs.core.count(argv) - first_child);
switch (G__64587) {
case (0):
